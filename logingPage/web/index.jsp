...
<html>
  ...
  <body bgcolor="#f5f5dc">
      ...
      <div id="box">
       <a href="http://localhost:8080/logingPage_war_exploded/index.jsp"><img id="logo_location"src="/img/logo.png"  alt="can't load image"></a>
    ...
    <div id="big_loging_box">
      ...
      <div id="small_loging_box">
        <form >
          ...
          <input class="input_box" id="submit" type="submit" value="登录"><br>
          <input id="check" type="checkbox"checked>自动登录<br>
          <a id="lost_pw" href="http://www.baidu.com">忘记密码?</a> | <a href="http://www.baidu.com">注册</a>
        </form>
      </div>
    </div>
